...
namespace xmlgui {
	...
	public:
		...
		void draw() {
			...
			xmlgui::Resources::drawString(this, "red", x+3, y+h4-5);
			xmlgui::Resources::drawString(this, "green", x+3, y+h4*2 - 5);
			xmlgui::Resources::drawString(this, "blue", x+3, y+h4*3 - 5);
			xmlgui::Resources::drawString(this, "alpha", x+3, y+height - 5);
			drawLabel(x+3, y-2);
